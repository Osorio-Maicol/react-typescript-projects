...
type HeaderProps = {
    ...
    incrementQuantity : (id: GuitarT["id"])=>void
    decrementQuantity : (id: GuitarT["id"])=>void
    clearCart: ()=>void
    isEmpty: boolean
    carTotal: number
}

const Header = ({ cart, removeCart, incrementQuantity, decrementQuantity, clearCart, isEmpty, carTotal }: HeaderProps) => {
