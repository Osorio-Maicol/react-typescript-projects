...
export const ActivityList = ({ activityState, dispatch, }: ActivityListProps) => {
                    ...
                    <div key={item.id} className="ring-1 ring-gray-200 w-full p-4 rounded-md bg-white flex flex-col gap-3">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex gap-3 text-sm font-semibold">
                                <button className="text-blue-600 hover:underline cursor-pointer" onClick={() => dispatch({ type: "update-activity", payload: { id: item.id } })}>
                                ...
                                <button className="text-red-600 hover:underline cursor-pointer" onClick={()=>dispatch({type: "delete-activity", payload: {id: item.id}})}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
