                                                    ...
                                                    <tr key={item.id}>
                                                        ...
                                                        <td className="flex align-items-start gap-4">
                                                            <button
                                                                ...
                                                                onClick={() => dispatch({type: "decrementQuantity", payload: {id: item.id}})}
                                                            >
                                                                -
                                                            </button>
                                                            {item.quantity}
                                                            <button
                                                                type="button"
                                                                className="btn btn-dark"
                                                                onClick={() => dispatch({type: "incrementQuantity", payload: {id: item.id}})}
                                                            >
                                                                +
                                                            </button>
                                                        </td>
                                                        <td>
                                                            <button
                                                                ...
                                                                type="button"
                                                                onClick={()=>dispatch({type: "removeCart", payload: {id: item.id}})}>
                                                                X
                                                            </button>
                                                        </td>
                                                    </tr>
